      ...
      <div class="container-fluid">
        ...
        <section class="my-5 py-5">
            <div class="container text-center mt-3 pt-5">
                <h2 class="form-weight-bold">Giriş Yap</h2>
                <hr class="mx-auto">
            </div>
            <div class="mx-auto container">
                <form id="login-form">
                    ...
                    <div class="form-group">
                        <label>Şifre</label>
                        <input type="password" class="form-control" id="login-password" name="password" placeholder="Şifre" required/>
                    </div>
                    <div class="form-group">
                        
                        <input type="submit" class="btn" id="login-btn" value="Giriş Yap"/>
                    </div>
                    <div class="form-group">
                        <a id="register-url" class="btn">Hesabınız Yok mu? Üye ol</a>
                    </div>
                </form>
            </div>
